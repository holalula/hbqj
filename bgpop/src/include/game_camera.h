...
//        uint8_t _pad1[0x50 - 0x10 - sizeof(Matrix4x4)];
//        Matrix4x4 projection_matrix_2;              // 0x50
//        uint8_t _pad2[0x90 - 0x50 - sizeof(Matrix4x4)];
//        Vector3 origin;                             // 0x90
...
//        uint8_t _pad3[0xE0 - 0xA0 - sizeof(Matrix4x4)];
...
//    class CameraBase {
//        uint8_t _pad0[0x10];
//        // Graphics::Scene::Camera SceneCamera;         // 0x10
//        // uint8_t _pad1[0x100 - 0x10 - sizeof(Graphics::Scene::Camera)];
